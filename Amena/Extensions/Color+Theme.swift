...
// Orange principal (#F97316), fond blanc/gris très clair, texte noir

import SwiftUI

extension Color {
    // Couleur principale orange (boutons, accents, textes mis en valeur)
    static let amenaPrimary = Color(hex: "#F97316")
    ...
    // Orange très pâle pour les dégradés de fond
    static let amenaOrangePale = Color(hex: "#FFF5EE")
    ...
    static let amenaSelectedBorder = Color(hex: "#F97316")
...
// Gradient de fond blanc → orange pâle (utilisé sur plusieurs écrans)
